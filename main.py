...
#     # Railway provides $PORT, default to 8000 for local development
...
#         host="0.0.0.0",
#         port=port,
#         reload=False,  # Important: disable in production
#         workers=1,  # Start with 1 worker, scale via Railway config
